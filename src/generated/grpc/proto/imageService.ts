...
export class ComputeUnitThreshold extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        community?: number;
        plus?: number;
        ...
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
        if (!Array.isArray(data) && typeof data == "object") {
            if ("community" in data && data.community != undefined) {
                this.community = data.community;
            }
            if ("plus" in data && data.plus != undefined) {
                this.plus = data.plus;
            }
            if ("expireAt" in data && data.expireAt != undefined) {
    ...
    set community(value: number) {
        pb_1.Message.setField(this, 1, value);
    }
    get plus() {
        return pb_1.Message.getFieldWithDefault(this, 2, 0) as number;
    }
    set plus(value: number) {
    ...
    static fromObject(data: {
        ...
        plus?: number;
        expireAt?: number;
    }): ComputeUnitThreshold {
        const message = new ComputeUnitThreshold({});
        if (data.community != null) {
            message.community = data.community;
        }
        if (data.plus != null) {
            message.plus = data.plus;
        }
        if (data.expireAt != null) {
            message.expireAt = data.expireAt;
        }
        return message;
    }
    toObject() {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        const writer = w || new pb_1.BinaryWriter();
        if (this.community != 0)
            writer.writeDouble(1, this.community);
        if (this.plus != 0)
            writer.writeDouble(2, this.plus);
        if (this.expireAt != 0)
            writer.writeInt64(3, this.expireAt);
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ComputeUnitThreshold {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ComputeUnitThreshold();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
                case 1:
                    message.community = reader.readDouble();
                    break;
                case 2:
                    message.plus = reader.readDouble();
                    break;
                case 3:
                    message.expireAt = reader.readInt64();
                    break;
                default: reader.skipField();
            }
        }
    ...
    static deserializeBinary(bytes: Uint8Array): ComputeUnitThreshold {
        return ComputeUnitThreshold.deserialize(bytes);
    }
}
export class EchoReply extends pb_1.Message {
    ...
    constructor(data?: any[] | ({
        ...
        if (!Array.isArray(data) && typeof data == "object") {
            ...
            if ("thresholds" in data && data.thresholds != undefined) {
                this.thresholds = data.thresholds;
            }
            if ("serverIdentifier" in data && data.serverIdentifier != undefined) {
    ...
    get thresholds() {
        return pb_1.Message.getWrapperField(this, ComputeUnitThreshold, 5) as ComputeUnitThreshold;
    }
    set thresholds(value: ComputeUnitThreshold) {
    ...
    set serverIdentifier(value: number) {
    ...
    static fromObject(data: {
        ...
        sharedSecretMissing?: boolean;
        thresholds?: ReturnType<typeof ComputeUnitThreshold.prototype.toObject>;
        serverIdentifier?: number;
    }): EchoReply {
        ...
        if (data.thresholds != null) {
            message.thresholds = ComputeUnitThreshold.fromObject(data.thresholds);
        }
        if (data.serverIdentifier != null) {
            message.serverIdentifier = data.serverIdentifier;
        }
        return message;
    }
    toObject() {
        ...
        if (this.thresholds != null) {
            data.thresholds = this.thresholds.toObject();
        }
        if (this.serverIdentifier != null) {
            data.serverIdentifier = this.serverIdentifier;
        }
        return data;
    }
    serialize(): Uint8Array;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.has_thresholds)
            writer.writeMessage(5, this.thresholds, () => this.thresholds.serialize(writer));
        if (this.serverIdentifier != 0)
            writer.writeUint64(6, this.serverIdentifier);
        if (!w)
            return writer.getResultBuffer();
    }
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    reader.readMessage(message.thresholds, () => message.thresholds = ComputeUnitThreshold.deserialize(reader));
                    break;
                case 6:
                    message.serverIdentifier = reader.readUint64();
                    break;
                default: reader.skipField();
            }
        }
...
export class ImageGenerationRequest extends pb_1.Message {
    ...
    constructor(data?: any[] | ({
        ...
        if (!Array.isArray(data) && typeof data == "object") {
            ...
            if ("chunked" in data && data.chunked != undefined) {
                this.chunked = data.chunked;
            }
        }
    }
    get image() {
    ...
    static fromObject(data: {
        ...
        if (data.chunked != null) {
            message.chunked = data.chunked;
        }
        return message;
    }
    toObject() {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.chunked != false)
            writer.writeBool(14, this.chunked);
        if (!w)
            return writer.getResultBuffer();
    }
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                ...
                case 13:
                    ...
                    break;
                case 14:
                    message.chunked = reader.readBool();
                    break;
                default: reader.skipField();
            }
        }
...
export class RemoteDownloadResponse extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        ...
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
        if (!Array.isArray(data) && typeof data == "object") {
            if ("bytesReceived" in data && data.bytesReceived != undefined) {
                this.bytesReceived = data.bytesReceived;
            }
            if ("bytesExpected" in data && data.bytesExpected != undefined) {
                this.bytesExpected = data.bytesExpected;
            }
            if ("item" in data && data.item != undefined) {
                this.item = data.item;
            }
            if ("itemsExpected" in data && data.itemsExpected != undefined) {
                this.itemsExpected = data.itemsExpected;
            }
    ...
    set bytesExpected(value: number) {
        pb_1.Message.setField(this, 2, value);
    }
    get item() {
        return pb_1.Message.getFieldWithDefault(this, 3, 0) as number;
    ...
    set itemsExpected(value: number) {
        pb_1.Message.setField(this, 4, value);
    }
    get tag() {
        return pb_1.Message.getFieldWithDefault(this, 5, "") as string;
    ...
    static fromObject(data: {
        ...
        const message = new RemoteDownloadResponse({});
        if (data.bytesReceived != null) {
            message.bytesReceived = data.bytesReceived;
        }
        if (data.bytesExpected != null) {
            message.bytesExpected = data.bytesExpected;
        }
        if (data.item != null) {
            message.item = data.item;
        }
        if (data.itemsExpected != null) {
            message.itemsExpected = data.itemsExpected;
        }
        if (data.tag != null) {
    ...
    toObject() {
        ...
        if (this.bytesExpected != null) {
            data.bytesExpected = this.bytesExpected;
        }
        if (this.item != null) {
            data.item = this.item;
        }
        if (this.itemsExpected != null) {
            data.itemsExpected = this.itemsExpected;
        }
        if (this.tag != null) {
            data.tag = this.tag;
        }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.bytesReceived != 0)
            writer.writeInt64(1, this.bytesReceived);
        if (this.bytesExpected != 0)
            writer.writeInt64(2, this.bytesExpected);
        if (this.item != 0)
            writer.writeInt32(3, this.item);
        if (this.itemsExpected != 0)
            writer.writeInt32(4, this.itemsExpected);
        if (this.tag.length)
            writer.writeString(5, this.tag);
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RemoteDownloadResponse {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RemoteDownloadResponse();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
                case 1:
                    message.bytesReceived = reader.readInt64();
                    break;
                case 2:
                    message.bytesExpected = reader.readInt64();
                    break;
                case 3:
                    message.item = reader.readInt32();
                    break;
                case 4:
                    message.itemsExpected = reader.readInt32();
                    break;
                case 5:
    ...
    static deserializeBinary(bytes: Uint8Array): RemoteDownloadResponse {
        return RemoteDownloadResponse.deserialize(bytes);
    }
}
export class ImageGenerationResponse extends pb_1.Message {
    #one_of_decls: number[][] = [[2], [4], [5], [7], [9]];
    constructor(data?: any[] | ({
        ...
        if (!Array.isArray(data) && typeof data == "object") {
            ...
            if ("downloadSize" in data && data.downloadSize != undefined) {
                this.downloadSize = data.downloadSize;
            }
            if ("chunkState" in data && data.chunkState != undefined) {
                this.chunkState = data.chunkState;
            }
            if ("remoteDownload" in data && data.remoteDownload != undefined) {
                this.remoteDownload = data.remoteDownload;
            }
        }
    }
    get generatedImages() {
    ...
    set downloadSize(value: number) {
        pb_1.Message.setOneofField(this, 7, this.#one_of_decls[3], value);
    }
    get has_downloadSize() {
        return pb_1.Message.getField(this, 7) != null;
    }
    get chunkState() {
        return pb_1.Message.getFieldWithDefault(this, 8, ChunkState.LAST_CHUNK) as ChunkState;
    }
    set chunkState(value: ChunkState) {
        pb_1.Message.setField(this, 8, value);
    }
    get remoteDownload() {
        return pb_1.Message.getWrapperField(this, RemoteDownloadResponse, 9) as RemoteDownloadResponse;
    }
    set remoteDownload(value: RemoteDownloadResponse) {
        pb_1.Message.setOneofWrapperField(this, 9, this.#one_of_decls[4], value);
    }
    get has_remoteDownload() {
        return pb_1.Message.getField(this, 9) != null;
    }
    ...
    get _downloadSize() {
        const cases: {
            [index: number]: "none" | "downloadSize";
        } = {
            0: "none",
            7: "downloadSize"
        };
    ...
    get _remoteDownload() {
        const cases: {
            [index: number]: "none" | "remoteDownload";
        } = {
            0: "none",
            9: "remoteDownload"
        };
    ...
    static fromObject(data: {
        ...
        downloadSize?: number;
        chunkState?: ChunkState;
        remoteDownload?: ReturnType<typeof RemoteDownloadResponse.prototype.toObject>;
        ...
        if (data.downloadSize != null) {
            message.downloadSize = data.downloadSize;
        }
        if (data.chunkState != null) {
            message.chunkState = data.chunkState;
        }
        if (data.remoteDownload != null) {
            message.remoteDownload = RemoteDownloadResponse.fromObject(data.remoteDownload);
        }
        return message;
    }
    toObject() {
        ...
        if (this.chunkState != null) {
            data.chunkState = this.chunkState;
        }
        if (this.remoteDownload != null) {
            data.remoteDownload = this.remoteDownload.toObject();
        }
        return data;
    }
    serialize(): Uint8Array;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.has_downloadSize)
            writer.writeInt64(7, this.downloadSize);
        if (this.chunkState != ChunkState.LAST_CHUNK)
            writer.writeEnum(8, this.chunkState);
        if (this.has_remoteDownload)
            writer.writeMessage(9, this.remoteDownload, () => this.remoteDownload.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    message.downloadSize = reader.readInt64();
                    break;
                case 8:
                    message.chunkState = reader.readEnum();
                    break;
                case 9:
                    reader.readMessage(message.remoteDownload, () => message.remoteDownload = RemoteDownloadResponse.deserialize(reader));
                    break;
                default: reader.skipField();
            }
        }
...
export class PubkeyResponse extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.pubkey.length)
            writer.writeString(2, this.pubkey);
        if (!w)
            return writer.getResultBuffer();
    }
...
export class HoursRequest extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {}) {
        super();
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
    ...
    static fromObject(data: {}): HoursRequest {
        const message = new HoursRequest({});
        return message;
    }
    toObject() {
        const data: {} = {};
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): HoursRequest {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new HoursRequest();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): HoursRequest {
        return HoursRequest.deserialize(bytes);
    }
}
export class HoursResponse extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        thresholds?: ComputeUnitThreshold;
    }) {
    ...
    get thresholds() {
        return pb_1.Message.getWrapperField(this, ComputeUnitThreshold, 1) as ComputeUnitThreshold;
    }
    set thresholds(value: ComputeUnitThreshold) {
    ...
    static fromObject(data: {
        ...
        const message = new HoursResponse({});
        if (data.thresholds != null) {
            message.thresholds = ComputeUnitThreshold.fromObject(data.thresholds);
        }
        return message;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        const writer = w || new pb_1.BinaryWriter();
        if (this.has_thresholds)
            writer.writeMessage(1, this.thresholds, () => this.thresholds.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): HoursResponse {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new HoursResponse();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): HoursResponse {
        return HoursResponse.deserialize(bytes);
    }
}
...
export abstract class UnimplementedImageGenerationServiceService {
    static definition = {
        ...
        Pubkey: {
            ...
            requestStream: false,
            responseStream: false,
            requestSerialize: (message: PubkeyRequest) => Buffer.from(message.serialize()),
            requestDeserialize: (bytes: Buffer) => PubkeyRequest.deserialize(new Uint8Array(bytes)),
            responseSerialize: (message: PubkeyResponse) => Buffer.from(message.serialize()),
            responseDeserialize: (bytes: Buffer) => PubkeyResponse.deserialize(new Uint8Array(bytes))
        },
        Hours: {
            path: "/ImageGenerationService/Hours",
            requestStream: false,
            responseStream: false,
            requestSerialize: (message: HoursRequest) => Buffer.from(message.serialize()),
            requestDeserialize: (bytes: Buffer) => HoursRequest.deserialize(new Uint8Array(bytes)),
            responseSerialize: (message: HoursResponse) => Buffer.from(message.serialize()),
            responseDeserialize: (bytes: Buffer) => HoursResponse.deserialize(new Uint8Array(bytes))
        }
    };
    ...
    abstract Pubkey(call: grpc_1.ServerUnaryCall<PubkeyRequest, PubkeyResponse>, callback: grpc_1.sendUnaryData<PubkeyResponse>): void;
    abstract Hours(call: grpc_1.ServerUnaryCall<HoursRequest, HoursResponse>, callback: grpc_1.sendUnaryData<HoursResponse>): void;
}
export class ImageGenerationServiceClient extends grpc_1.makeGenericClientConstructor(UnimplementedImageGenerationServiceService.definition, "ImageGenerationService", {}) {
    ...
    Pubkey: GrpcUnaryServiceInterface<PubkeyRequest, PubkeyResponse> = (message: PubkeyRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<PubkeyResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<PubkeyResponse>, callback?: grpc_1.requestCallback<PubkeyResponse>): grpc_1.ClientUnaryCall => {
        return super.Pubkey(message, metadata, options, callback);
    };
    Hours: GrpcUnaryServiceInterface<HoursRequest, HoursResponse> = (message: HoursRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<HoursResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<HoursResponse>, callback?: grpc_1.requestCallback<HoursResponse>): grpc_1.ClientUnaryCall => {
        return super.Hours(message, metadata, options, callback);
    };
}
